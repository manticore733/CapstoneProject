...
// import { ClientUserReportDto, ReportRecord, ReportResultDto } from '../../../../core/models/ClientUserReportDto'; // <-- Make sure this path is correct
// import { ReportService } from '../../../../core/services/report-service';
// import { CommonModule } from '@angular/common';
// import { catchError, of } from 'rxjs'; // <-- Make sure catchError and of are imported
...
//   runReport(): void {
//     // --- 1. CHECK IF THE FUNCTION IS CALLED ---
...
//     // --- 3. CHECK IF THE SERVICE IS CALLED ---
//     console.log('Calling reportService.getClientReport...');

//     this.reportService.getClientReport(startDate || undefined, endDate || undefined).subscribe({
//       next: (data) => {
//         // --- 4. CHECK THE SUCCESSFUL RESPONSE ---
...
//   loadHistory(): void {
//     console.log('loadHistory() CALLED.'); // <-- Added debug log
...
//     // --- 2. CHECK THE DATA BEING SENT ---
//     console.log('Filters being sent to API for EXCEL:', { startDate, endDate });

//     this.reportService.generateClientReportExcel(startDate || undefined, endDate || undefined).subscribe({
//       next: (result: ReportResultDto) => {
//         // --- 3. CHECK THE SUCCESSFUL RESPONSE ---
